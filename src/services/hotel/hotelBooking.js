...
export const performHotelBooking = async (dispatch, hotelBookingData) => {
  ...
  try {
    const successHotelBookingResult = await post(apiEndpoint, hotelBookingData);
    return successHotelBookingResult;
  } catch (err) {
